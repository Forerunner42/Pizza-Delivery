...
function startPreparation()
{
    ...
    addUpdate("Timer Method", `Using setTimeout(${processSteps[0].duration * 1000}) to simulate moving to "${processSteps[1].name}" stage (${processSteps[0].duration / 60} minutes in real life)`);

    // Set timeout for the first step transition
...
function markAsPickedUp()
{
    ...
    addUpdate("Timer Method", "All timers stopped with clearInterval() and clearTimeout()");
}